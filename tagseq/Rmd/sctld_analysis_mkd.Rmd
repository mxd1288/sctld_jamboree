...
# create design matrix
design_matrix <- model.matrix(~ ofav_meta$Correct_treatment - ofav_meta$Project)
design_matrix <- design_matrix[,1:2]
...
# create design matrix
design_matrix <- model.matrix(~ mcav_meta$Correct_treatment - mcav_meta$Project)
design_matrix <- design_matrix[,1:2]
...
# Cleaning up the Ofav
variance may be due to some unknown factor -- maybe able to remove with SVA ()
```{r}
